...
namespace Mkey
{
    public class PaytableSymb : MonoBehaviour
    {
        ...
        public void Create(RectTransform parent, string pay5xS, string pay4xS, string pay3xS, string prefix, Sprite symbSprite)
        {
            ...
            ImageExtension.SetImageSprite(image, symbSprite,true);
