...
namespace Mkey
{
    public class AdsControl : MonoBehaviour
    {
        ...
        [SerializeField]
        private string bannerAdUnitIdIos = "ca-app-pub-3940256099942544/6300978111"; // test
        ...
        [SerializeField]
        private string interstitialAdUnitIdIos = "ca-app-pub-3940256099942544/1033173712";
        ...
        public void ShowRewardedAd(string name, Action rewardedOpenedCallBack, Action rewardedClosedCallBack, Action<bool, string, double> rewardCallBack)
        {
            if (rewardAds == null || rewardAds.Count == 0) return;
            ...
            foreach (var item in rewardAds)
            {
                if (item.Name == name) rA = item;

            }
            if (rA == null)
            {
                Debug.Log("Rearded ad: " + name + " not exist");
                return;
            }
    ...
    public class RewardAd
    {
        ...
        [SerializeField]
        private string adUnitIdIOS = "ca-app-pub-3940256099942544/5224354917";      // test
 ...
 * 
Format: Interstitial
ID: ca-app-pub-5045703402007794/9877904031

Format: Rewarded video
ID: ca-app-pub-5045703402007794/3396256167


android   ca-app-pub-5045703402007794~3747733664
IOS  App ID: ca-app-pub-5045703402007794~2726296039
